...
from admin import get_products_bp, set_products_bp, get_set_edit_products_bp, stat_bp
from shop import auth_bp, reg_bp, home_products_bp, cart_products_bp
...
app.register_blueprint(cart_products_bp)
